...
# Creates a network from IBD data
...
### Make the graph
graph <- input(kind = kind, path = path, data = file_name, info = metadata, max = m_parameter, prune = 0)[[1]]
